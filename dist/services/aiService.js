...
`;
// --- 3. CÁC HÀM DỊCH VỤ ---
export async function parseIntent(query, lastBotQuestion) {
...
export async function generateAnswer(query, places, intent) {
    let prompt = "";
...
export async function getGeneralAnswer(query) {
...
export async function continueItinerary(query, knownSlots) {
    const requiredSlots = [
        'days',
        'groupSize',
        'traveler_type',
...
// [HÀM MỚI]
export async function askForNextSlot(knownSlots, nextSlot) {
